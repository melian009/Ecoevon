...
%Plot-----------------------------
subplot(3,2,1)
hr1 = plot(Zra, pdfNormal,'g',"markersize", 12);
%a =unifrnd(0,1);
%b =unifrnd(0,1);
%c =unifrnd(0,1);
%set(hr1,'color',[a b c]);
set(hr1,'LineWidth',4);
xlabel('Abiotic trait C species',"fontsize",14)
...
subplot(3,2,2)
hr1 = plot(WA(:,1),WA(:,2),'g',"markersize", 12);%Visualize
%a =unifrnd(0,1);
%b =unifrnd(0,1);
%c =unifrnd(0,1);
%set(hr1,'color',[a b c]);
...
subplot(3,2,3)       
hr1 = plot(Zi,pdfNormal,'b',"markersize", 12);%Visualize
...
%set(hr1,'color',[a b c]);
set(hr1,'LineWidth',4);
xlabel('Dispersal trait C species',"fontsize",14)
ylabel('Frequency',"fontsize",14)
set(gca,'fontsize',14);
...
subplot(3,2,4)
hr1 = plot(WD(:,1),WD(:,2),'b',"markersize", 12);%Visualize
%a =unifrnd(0,1);
%b =unifrnd(0,1);
%c =unifrnd(0,1);
%set(hr1,'color',[a b c]);
...
%fitness function consumer------------------------------------------------------
for pB = 1:length(Zrb);
WB(pB,2) = exp(-gamma*(Zrb(1,pB) - mean(Zcb))^2);
...
%set(hr1,'color',[a b c]);
set(hr1,'LineWidth',4);
xlabel('Biotic trait C species',"fontsize",14)
ylabel('Frequency',"fontsize",14)
set(gca,'fontsize',14);
